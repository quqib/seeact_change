...
| default_website | Default starting website  | str | https://www.bing.com/ | no |
...
|----------|-------|---------------|---------|:-----------:|
| OpenAI | ByteDance-Seed/Seed-OSS-36B-Instruct | High | OPENAI_API_KEY in env |  |
...
or you can press `Enter` to use the default Google homepage (https://www.bing.com/). 
